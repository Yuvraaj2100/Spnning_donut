...
theta_spacing = 10
phi_spacing = 1  # for faster rotation change to 2, 3 or more, but first change lines 86, 87 as commented
...
while run:
    ...
    for i in range(len(b)):
        A += 0.00004  # for faster rotation change to a bigger value
        B += 0.00002  # for faster rotation change to a bigger value
        if i == 0 or i % columns:
